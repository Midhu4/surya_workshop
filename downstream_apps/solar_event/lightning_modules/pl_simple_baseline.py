...
A minimal PyTorch Lightning wrapper for training a solar event identification model.

This module defines a single LightningModule (SolarEventLightningModule) that:
...
class SolarEventLightningModule(L.LightningModule):
    """
    PyTorch LightningModule for solar event identification training.
...
# Temporarily leave it for a moment.
class SolarEventSURYALightningModule(L.LightningModule):
    """
    PyTorch LightningModule for solar event identification training.
